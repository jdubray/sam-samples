...
Note: Several packages need to be installed by hand
npm install @angularclass/hmr @angularclass/hmr-loader
npm install @angular/forms
npm install @angular/http
npm install @angular/router
npm install @angular/core@2.0.2
npm install @angular/common@2.0.2
npm install rxjs@5.0.0-beta.6
npm install rxjs@5.0.0-beta.12
npm install @angular/platform-browser@2.0.2
