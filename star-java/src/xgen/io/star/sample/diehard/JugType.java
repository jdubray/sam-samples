...
public class JugType extends Type {

	public static final Integer bigSize = 5 ;
	public static final Integer smallSize = 3 ;
	
	Integer _big ;
	Integer _small ;
	
	public JugType(Integer big, Integer small) {
		super() ;
		_big = big ;
		_small = small ;
	...
	protected boolean sync() {
		_big = (Integer)_instance.get("big") ;
		_small = (Integer)_instance.get("small") ;
		return true;
	}
