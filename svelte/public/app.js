...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\n\n// Model\nvar model = {\n    _acceptors: [],\n    present: function present(proposal) {\n        // acceptors\n\n        model._acceptors.forEach(function (a) {\n            return a(proposal);\n        });\n\n        // Continue to state representation\n        state();\n    }\n};\n\n// State Represenation\nvar _render = function _render() {\n    return null;\n};\nvar _reactors = [];\nvar state = function state() {\n    // Reactors would go here\n\n    _reactors.forEach(function (r) {\n        return r();\n    });\n\n    _render(model);\n};\n\nvar init = function init(component, act) {\n    var render = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _render;\n    var actions = component.actions,\n        acceptors = component.acceptors,\n        reactors = component.reactors;\n\n\n    if (actions && acceptors && reactors) {\n        // Initialize the pattern\n        var _actions = actions.map(function (a) {\n            return a(model.present);\n        });\n        acceptors.map(function (a) {\n            return model._acceptors.push(a(model));\n        });\n        _reactors = reactors.map(function (r) {\n            return r(model);\n        });\n        return _actions;\n    } else {\n        // Process action\n        _render = render;\n        // get initial state from app\n        Object.assign(model, component.get());\n        act();\n    }\n};\n\nexports.default = init;\n\n//# sourceURL=webpack:///./src/SAM.js?");
