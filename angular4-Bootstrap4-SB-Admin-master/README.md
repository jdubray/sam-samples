# SB Admin rewritten in Angular4,  Bootstrap 4 and the SAM Pattern

This project has been modified by [Jean-Jacques Dubray](http://www.ebpml.org/about) to use the [SAM Pattern](http://sam.js.org)

The Simple Dashboard Admin App is built using Angular 4 and Bootstrap 4
